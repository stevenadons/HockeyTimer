...
let LS_BUYPREMIUM_TEXT_CARD = NSLocalizedString("Watch one ad to keep track of a penalty card (including timing). Or upgrade to Premium Mode with a one time payment.\n\nIn addition, in Premium Mode you can have dark mode and change the app icon.", comment: "Title of buy premium VC")
