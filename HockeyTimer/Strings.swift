...
let LS_MENU_ALWAYS_DARK = NSLocalizedString("Always show dark mode", comment: "Menu")
let LS_MENU_LIGHT = NSLocalizedString("Light", comment: "Menu")
let LS_MENU_NEVER_DARK = NSLocalizedString("Never show dark mode", comment: "Menu")
