...
let LS_BUYPREMIUM_TEXT_CARD = NSLocalizedString("Adding penalty cards is possible in Premium Mode with a one time payment. Give it a try for free by watching just one ad.\n\nPremium Mode will also let you have dark mode and change the app icon.", comment: "Title of buy premium VC")
