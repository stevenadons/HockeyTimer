...
let LS_MENU_DARK = NSLocalizedString("Dark", comment: "Menu")
let LS_MENU_ALWAYS_DARK = NSLocalizedString("Always show in dark mode", comment: "Menu")
let LS_MENU_LIGHT = NSLocalizedString("Light", comment: "Menu")
let LS_MENU_NEVER_DARK = NSLocalizedString("Never show in dark mode", comment: "Menu")
let LS_MENU_PHONE_SETTINGS = NSLocalizedString("Phone settings", comment: "Menu")
let LS_MENU_FOLLOW_PHONE_SETTINGS = NSLocalizedString("Follow your phone settings", comment: "Menu")
