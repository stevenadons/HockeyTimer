...
let LS_UPGRADE_DARK_MODE = NSLocalizedString("Dark mode comes with cool colors.", comment: "Text in upgradeVC")
let LS_UPGRADE_PENALTY_CARDS = NSLocalizedString("Log penalty cards and get noticed when the penalty time expires.", comment: "Text in upgradeVC")
let LS_UPGRADE_APP_ICON = NSLocalizedString("Choose any of your favorite app icons.", comment: "Text in upgradeVC")
