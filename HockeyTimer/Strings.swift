...
let LS_RESTART = NSLocalizedString("Restart", comment: "Menu Button")
let LS_TIME = NSLocalizedString("Time", comment: "Menu Button")
let LS_REPORT = NSLocalizedString("Report", comment: "Menu Button")
let LS_RULES = NSLocalizedString("Rules", comment: "Menu Button")
...
let LS_BUYPREMIUM_TEXT_DARK_MODE = NSLocalizedString("To have dark mode, upgrade to Premium Mode with a one time payment.\n\nIn addition, in Premium Mode you can change the app icon, create game reports and keep track of penalty cards.", comment: "Title of buy premium VC")
let LS_BUYPREMIUM_TITLE_CARD = NSLocalizedString("Penalty Card", comment: "Title of buy premium VC")
let LS_BUYPREMIUM_TEXT_CARD = NSLocalizedString("Penalty cards can be added in Premium Mode with a one time payment.\n\nPremium Mode will also let you have dark mode, create game reports and change the app icon.", comment: "Title of buy premium VC")
let LS_BUYPREMIUM_TITLE_CHANGE_APP_ICON = NSLocalizedString("Change App Icon", comment: "Title of buy premium VC")
let LS_BUYPREMIUM_TEXT_CHANGE_APP_ICON = NSLocalizedString("To change the app icon, upgrade to Premium Mode with a one time payment.\n\nIn addition, in Premium Mode you can have dark mode, create game reports and keep track of penalty cards.", comment: "Title of buy premium VC")
let LS_BUYPREMIUM_TITLE_GAME_REPORT = NSLocalizedString("Game Report", comment: "Title of buy premium VC")
let LS_BUYPREMIUM_TEXT_GAME_REPORT = NSLocalizedString("To create Game Reports, upgrade to Premium Mode with a one time payment.\n\nIn addition, in Premium Mode you can keep track of penalty cards, change the app icon and have dark mode.", comment: "Title of buy premium VC")
